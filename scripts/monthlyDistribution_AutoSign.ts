...
export async function run( provider: NetworkProvider) {
    ...
    try {
        ...
        const mnemonic = process.env.mainContractAdmin!; // your 24 secret words (replace ... with the rest of the words)
            ...
            try {
                ...
                if (matrixRegistrationDate) {
                    ...
                    if (matrixUserData.matrixSubscriptionType != null) {
                        ...
                        console.log(user.username, '=======', seqno);
                        ...
                        console.log(`transaction confirmed and Distribution sent for ${user.username}`);
                        console.log('======================================');
        ...
        if (matrixRegistrationDate) {
            ...
            if (matrixUserData.matrixSubscriptionType != null) {
                ...
                console.log(`Transaction confirmed and Distribution sent for Company Position`);
                console.log('======================================');
            } else {
